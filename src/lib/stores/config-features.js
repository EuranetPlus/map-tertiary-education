export const config = {
	mapTitle: 'tertiary-education', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-tertiary-education.vercel.app/', // The url provided when deploying the map on Vercel
